...
function lib.getVehicleProperties(vehicle)
	if DoesEntityExist(vehicle) then
		...
		return {
			...
			bodyHealth = math.floor(GetVehicleBodyHealth(vehicle) + 0.0),
			engineHealth = math.floor(GetVehicleEngineHealth(vehicle) + 0.0),
			tankHealth = math.floor(GetVehiclePetrolTankHealth(vehicle) + 0.0),
			fuelLevel = math.floor(GetVehicleFuelLevel(vehicle) + 0.0),
			oilLevel = math.floor(GetVehicleOilLevel(vehicle) + 0.0),
			dirtLevel = math.floor(GetVehicleDirtLevel(vehicle) + 0.0),
